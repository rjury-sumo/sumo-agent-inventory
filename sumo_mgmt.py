...
parser.add_argument('-output', metavar='', type=str, default='table',help='Use table or json for ouptut of listVersions')
...
def print_collector_table(collectors, headings,output='table'):
    '''
    ...
    if output == 'json':
        for collector in collectors:
            log('[INFO] %s' % (json.dumps(collector)))
...
if __name__ == "__main__":
    if validate():
        ...
        print_collector_table(collectors, table_headings,args.output)
